...
class AddVisitingHelpOne extends StatefulWidget {
  final name;

  const AddVisitingHelpOne({Key key, this.name}) : super(key: key);
  @override
  _AddVisitingHelpOneState createState() => _AddVisitingHelpOneState();
}

class _AddVisitingHelpOneState extends State<AddVisitingHelpOne> {
