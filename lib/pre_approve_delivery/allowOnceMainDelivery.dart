...
import 'allowFrequentlyMainScreen.dart';

class AllowOnceDelivery extends StatefulWidget {
  @override
  _AllowOnceDeliveryState createState() => _AllowOnceDeliveryState();
}

class _AllowOnceDeliveryState extends State<AllowOnceDelivery>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: TabBarView(
          children: [_allowOnce(), AllowFrequentily()],
          controller: _tabController,
        ));
  }
