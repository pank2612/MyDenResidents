...
class _EventScreenState extends State<GatesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Society Gates',style: TextStyle(color: UniversalVariables.ScaffoldColor),),
                  ...
                  child: GestureDetector(
                    ...
                    child: Stack(
                        children: [
                          ...
                          //   child: GestureDetector(
                          //     onTap: (){
                          //       Route route = CupertinoPageRoute(builder: (context) => updateGateData(
                          //           gate: gateList[
                          //           index]
                          //       ));
                          ...
                          //             fontSize: 12,color: UniversalVariables.background),),
                          //       ),
                          //
                          //     ),
                          //   ),
